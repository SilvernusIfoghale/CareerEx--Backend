...
console.log(getDrugsByCategory("Antibiotic")); // Example usage
...
function getDrugsWithLowStock() {
  return drugs.filter((drug) => drug.stock < 50);
}
console.log(getDrugsWithLowStock());
...
console.log(countDrugsByManufacturer("Pfizer")); // Example usage
